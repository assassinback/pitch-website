...
if(! defined('MAX_FILE_SIZE') )				define ('MAX_FILE_SIZE', 60485760);						// 10 Megs is 10485760. This is the max internal or external file size that we'll process.  
...
if(! defined('MAX_WIDTH') )					define ('MAX_WIDTH', 1800);								// Maximum image width
if(! defined('MAX_HEIGHT') )				define ('MAX_HEIGHT', 1800);							// Maximum image height
