...
$dbs_checked =   $userInfo['dbs_checked'];
...
$dbs_checked =   isset($_REQUEST["dbs_checked"])?$_REQUEST["dbs_checked"]:0;
					...
					<div class="reg_ul">
                        <form role="form" class="validateForm" name="Admin" action="" method="post" enctype="multipart/form-data">
                            ...
                            <ul class="register-fields">
                                ...
                                <?php /* 
                                    if($profile_image!=''){
                                    $src = USER_URL . $profile_image;  
                                ?>
								<img src="<?php echo $src; ?>"  height='150' width='100'/>
								<?php } */ ?>
                                                                
                                <li class="text_cum">
                                    <label>Profile Picture </label><br>
                                    <div class="edit-profile-image" >
                                    <?php echo getUserProfileImage($userInfo['photo'], 'scout', 'width="100"'); ?>
                                    </div><br><br>
                                ...
                                <li class="text_cum">
                                    ...
                                    <input type="text" name="testimonial_of_how_good_coach_i_am_video" id="testimonial_of_how_good_coach_i_am_video" value="<?php echo $testimonial_of_how_good_coach_i_am_video; ?>" class="form-control input3 mini txt_lg" placeholder="Enter valid youtube video url" >
