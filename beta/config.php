...
define("SITE_URL", "http://".$_SERVER['SERVER_NAME'] ."/" . SUBDIRECTORY);
define("ADMIN_URL", "http://".$_SERVER['SERVER_NAME'] ."/" . SUBDIRECTORY . "admin/");

// define("SITE_URL", "http://beta.".$_SERVER['SERVER_NAME'] ."/" . SUBDIRECTORY);
// define("ADMIN_URL", "http://beta.".$_SERVER['SERVER_NAME'] ."/" . SUBDIRECTORY . "admin/");
...
$dbPrefix = "pitch_";
$dbHost = "localhost"; 
$dbName = "pitchrmt_beta";
$dbUser = "pitchrmt_beta";
$dbPass = "Qcav218@"; 
